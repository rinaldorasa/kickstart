document.getElementById("piedipagina_menu_test").innerHTML=
' <section  style="position:fixed; bottom:0; left:0; width:100%; text-align:left; border:solid 0rem green;">  '+
...
'  <div id="collapsemenuapdp" class="collapse dropdown-menuY  border-0"   '+ 	
...
' <ul style="border:solid 0.25rem indigo !important;  height:11.5rem !important; overflow:auto !important; border-radius:0.2rem !important; ">'+
	
' 	<a class="btn-warning rounded"   '+ 
'  href="http://beatsupernovarasa.altervista.org/index.html">  '+ 	
'  	<span>home_page</span></a>  '+ 	

' 	 '+ 	'     '+  	
' </ul>  '+ 	
' 	 '+ 	' versione bs5  agg-b1  20201208_1030    '+
' </div> '+
' </span> '+
' </section>  '+
